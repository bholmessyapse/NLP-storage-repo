def make_rxnorm_wordlists():
    ...
    dataloc = '/Users/bholmes/Desktop/SpellCheck/data/'
    ...
    word_out_file = '/Users/bholmes/Desktop/SpellCheck/data/wordlists/rxnorm_words.txt'
    phrase_out_file = '/Users/bholmes/Desktop/SpellCheck/data/data/wordlists/rxnorm_phrases.txt'
