...
patientsMinusPSJH = pd.read_csv("/Users/bholmes/Desktop/NDI/GoogleSheets/patientsMinusPSJH.csv", low_memory=False)
...
#sensitivitySheet = pd.read_csv("/Users/bholmes/Desktop/NDI/GoogleSheets/UPDATED DoD 5-category Data - May 7, 2020 - Data_2.csv", low_memory=False)
#sensitivitySheet = pd.read_csv("/Users/bholmes/Desktop/NDI/GoogleSheets/UPDATED DoD 5-category Data - May 7, 2020 - Data.csv", low_memory=False)
sensitivitySheet = pd.read_csv("/Users/bholmes/Desktop/NDI/GoogleSheets/UPDATED2.csv", low_memory=False)
...
diagnosisDate = pd.read_csv("/Users/bholmes/Desktop/NDI/GoogleSheets/DiagnosisDates.csv", low_memory=False)
...
allPatientInfo = allPatientInfo.drop_duplicates()
...
#patientsMinusPSJH columns:
# 'Unnamed: 0', 'recordid', 'patient_id', 'sourcename'

#allMetastaticIds columns: (you want 'x')
# 'Unnamed: 0', 'x'

#featureFrame Columns
...
# FOR RACE SEX AGE NOT NAN
#sensitivityLowerCutoff = sensitivityMinusPSJH[(sensitivityMinusPSJH['race'] != 'Unknown') & (sensitivityMinusPSJH['sex'] != 'Unknown') & (sensitivityMinusPSJH['sex'] is not np.nan) & (sensitivityMinusPSJH['race'] is not np.nan)]
...
print(len(sensitivityOfBelow30kLower) + len(sensitivityOf30to60KLower) + len(sensitivityOf60to100KLower) + len(sensitivityOf100to185KLower) + len(sensitivityOf185kUpLower) + len(sensitivityOfNAPostLower))

print(len(sensitivityOf30to60KLower))
...
for inputDataFrame in idf:
    ...
    for x in range(0, len(positivesValues)):
        ...
        numWithExact = len(inputDataFrame[(inputDataFrame[columnDates] == 0) & (inputDataFrame[columnPos] == 'TP')]) + len(inputDataFrame[(inputDataFrame[columnDates].isna()) & (inputDataFrame[columnPos] == 'TP')])
